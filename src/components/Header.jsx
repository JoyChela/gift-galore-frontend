      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-8">
            <li>
              <Link to="/" className="flex items-center text-lg hover:text-red-500">
                <Home size={20} className="mr-1" /> Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="flex items-center text-lg hover:text-red-500">
                <Info size={20} className="mr-1" /> About Us
              </Link>
            </li>
            <li>
              <Link to="/signup" className="flex items-center text-lg hover:text-red-500">
                <UserPlus size={20} className="mr-1" /> Sign Up
              </Link>
            </li>
            {/* Search Bar Toggle */}
            {searchVisible ? (
              <form onSubmit={handleSearch} className="flex items-center space-x-2" ref={searchRef}>
                <input
                  type="text"
                  value={query}
                ...
                />
                <button type="button" onClick={() => setSearchVisible(false)} className="text-white">
                  Close
                </button>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link to="/profile" className="flex items-center bg-white p-2 rounded">
